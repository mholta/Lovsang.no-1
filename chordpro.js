/*// Temp file import for testing

function readTextFile(file) {
  var rawFile = new XMLHttpRequest();
  var allText = "Problem ved lasting av fil, prøv annen nettleser";
...
const sheet = "testSheet.txt"? readTextFile("testSheet.txt") : ""; 
...
function convertSheet(sheet) {
  ...
  var isChordLine = (line) => {
    var line = line.trim().replace(/\/+|\|+|\-+/g, '').replace(/x[0-9]+/g, ''); // Last regex adds ability to have x2 after simple chord line
